<template>
    <div>
        ...
        <div class="bg-img relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover bg-center relative items-center"
            ...
            <div class="max-w-md w-full space-y-8 p-10 opacity-60 bg-white shadow-lg rounded-xl z-10">
...
<!--                         <div class="flex items-center justify-center space-x-2 mt-5">
                    ...
                    <div class="flex flex-col mt-5">
                        <p class="text-center">This addon was created by:
                            ...
                            Background by:
                            <a href="https://github.com/jpants36" target="_blank" class="text-purple-700"><b style="font-weight: 600;">jpants</b></a>
                            .
                        </p>
                    </div>
                </div>
